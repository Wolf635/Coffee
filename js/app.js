(() => {
    ...
    function initSliders() {
        if (document.querySelector(".feedback__swiper")) new swiper_core_Swiper(".feedback__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 900,
            navigation: {
                prevEl: ".swiper-button-prev.slide-feedback__arrow",
                nextEl: ".swiper-button-next.slide-feedback__arrow"
            },
            on: {}
        });
    }
